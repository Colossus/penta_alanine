...
radius=40.0  # radius can be changed in the middle of the simulation.
...
max_num_steps=60  # maximum number of steps for the simulation.
...
num_balls_for_sc=10  # minimum number of balls present to perform spectral clustering for that step
num_clusters=5  # number of clusters for k-means part of spectral clustering
num_walkers_for_sc=10  # number of walkers for each macrostate, usually set equal to the avg number of walkers per
