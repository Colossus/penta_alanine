...
export MAIN_DIRECTORY=/scratch/users/jbirgmei/CS229/WE_Penta_Alanine  # TODO: set main directory for WE simulation
num_nodes=1  # TODO: set number of nodes requested
num_cpu=2  # TODO: set number of cores per node
